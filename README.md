...
2. Three server-side applications implemented in Java:
   - "gazetteer": translates a set of GPS coordinates into a location name (e.g. "Weimar, Thüringen, Deutschland")
   - "weatherstations": provides access to the database of weatherstations, allows for requesting all at once and the climate data for one station in one time period
   - "thredds": the THREDDS Data Server (TDS) provides access to the actual climate data (temperature and precipitation per year)
   
Live system: https://climatecharts.net

## Source Code

The Client-side webapp can be found here: 
https://github.com/GeoinformationSystems/climatecharts

The Server-side applications can be found here:
* gazetteer: https://github.com/GeoinformationSystems/gazetteer
* weatherstations: https://github.com/GeoinformationSystems/weatherstations
* thredds: https://github.com/Unidata/tds
...
```
  ...
  |- Tomcat_local         // local Tomcat instance
```
...
The ClimateCharts project is lincensed under the Apache License 2.0.

### Javascript Libraries
The website uses a collection of Javascript libraries:

* Bootstrap 3.4.1, https://getbootstrap.com/ - MIT license
