...
var Map = function () {
  ...
  function Map(main) {
    ...
    var baseMaps = {
      "ESRI_WorldMap": L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}', {
        maxZoom: 20,
    ...
    this._map.on("click", function (e) {
      ...
      _this._locationController.setPosition(coords);
    });
  }
  ...
  _createClass(Map, [{
    key: 'makeCellVisible',
    value: function makeCellVisible() {
      ...
      else if (!mapBounds.contains(cellBounds)) this._map.fitBounds(cellBounds);
